...
class InfoTableViewController: UITableViewController {
    ...
    let giftNumber = randomNumberForGift
    ...
    func createEverything() {
        ...
        // MARK:- create gifts
        let gifts = CoreModelOfGifts(numberOfPresets: randomNumberForGift)
    ...
    func createRefreshing() {
        self.refreshControl?.addTarget(self, action: #selector(InfoTableViewController.RefreshControl(_:)), for: .valueChanged)
    }
